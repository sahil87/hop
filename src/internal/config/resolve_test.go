...
func TestResolveNotFound(t *testing.T) {
	...
	want := "hop: no hop.yaml found at " + filepath.Join(home, ".config", "hop", "hop.yaml") + ". Run 'hop add -r ~/code' to build it from your existing clones, or 'hop config init' for a starter."
	if err.Error() != want {
